...
//  $_SESSION['pic']=$fileNewName;
//  $_SESSION['firstname']=$firstname;
 
 $sql = "INSERT INTO admintable (firstname,lastname,password, email, picture)
 VALUES ('$firstname', '$lastname','$workerpassword','$email','$fileNewName')";
