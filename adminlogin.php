...
$sql="SELECT * FROM tableofadmin WHERE email='$mail'";
$res=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($res,MYSQLI_ASSOC);
if($mail==$row['email'] && $userpassword==$row['adminpassword']){
...
<div class="card-body">
  ...
  <form action="adminlogin.php" method="post">
    ...
    <p>Don't have an account?<p><a href="registeradmin.php">REGISTER</a>
<br>
    <br>
